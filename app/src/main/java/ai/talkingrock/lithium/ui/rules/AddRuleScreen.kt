...
fun AddRuleScreen(
    ...
    when {
        uiState.isLoadingPackages -> {
            ...
            // imePadding so the scrolling Column shrinks when the keyboard
            // opens, keeping the focused Description / Channel filter field
            // visible — fixes issue #68 alongside ChatScreen's equivalent.
            Column(
                modifier = Modifier
                    .fillMaxSize()
                    .imePadding()
